...
rem downterm 3.2.0 — minimal terminal UI only (no window GUI)
rem   downterm            → menu
...
cls
echo.
echo   %ACC%downterm%R%  %FAINT%3.2.0%R%
echo   %HAIR%..........................................%R%
echo.
...
echo     close the window → open NEW PowerShell → type:  downterm
echo.
echo   %MUT%if PowerShell still says not recognized%R%
echo     - you must open a brand-new terminal after install
echo     - or run:  download.bat --install   again
echo.
echo   %MUT%keys%R%
